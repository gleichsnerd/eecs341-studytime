class MeetingTimesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @meeting_time.save
        ...
        format.json { render :show, status: :created, location: @meeting_time }
      else
  ...
  def update
    respond_to do |format|
      if @meeting_time.update(meeting_time_params)
        ...
        format.json { render :show, status: :ok, location: @meeting_time }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to meeting_times_url, notice: 'Meeting time was successfully destroyed.' }
  ...
  private
    ...
    def meeting_time_params
      params.require(:meeting_time).permit(:study_group_id, :mtime)
    end
end
